# Quality gate — v2.15.0

- PASS: pytest — `uv run pytest`
...
- PASS: ui-typecheck — `npm --prefix packages/ui run typecheck` (required: toolchain present)
- PASS: ui-build — `npm --prefix packages/ui run build` (required: toolchain present)
